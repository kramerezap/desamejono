...
$ambilberita = DB::table('tb_berita')->where('VIEW',1)->get();
?>
<!-- DataTables CSS -->
...
@section('content')
 ...
 @php 
      $dat = DB::table('tb_berita')->where('VIEW',1)->get();
      @endphp
      @foreach($dat as $data)  
<div class="modal fade" id="modal-edit{{$data->ID_BERITA}}">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="/admin:updateberita={{$data->ID_BERITA}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <br>
                     <label class="col-sm-8 col-sm-8 control-label">Judul Berita :</label>
                                        <input type="text" style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" value="{{$data->JUDUL_BERITA}}" class="form-control" id="judul" name="judul" placeholder="Contoh : Pembuatan Tahu" required="true">
                  ...
                  <div class="form-group">
                     ...
                     <label class="col-sm-8 col-sm-8 control-label">ISI BERITA :</label>
                    <textarea class="textarea" value="{{$data->ISI_BERITA}}" placeholder="Tahu Adalah....." name="isi" 
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$data->ISI_BERITA}}</textarea>
                    <br>
...
<div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="/admininsertberita" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body">
                  <div class="form-group">
                     <label class="col-sm-2 col-sm-2 control-label">Foto</label>
            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="tabelproduk">
                        ...
                        <tbody>
                          @foreach($ambilberita as $data) 
                            <tr>
                              <td>{{$data->ID_BERITA}}</td>
                                 <td><img src="Assets/images/berita/{{$data->GAMBAR}}" width="60" height="60" alt="User"></td>
                                 <td>{{$data->GAMBAR}}  </td>
                                 ...
                                 <td>{{$data->ISI_BERITA}}</td>
                                  <td>
                                    <form>
                                      ...
                                      <a href="#" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#modal-edit{{$data->ID_BERITA}}">
                                        <i class="material-icons">mode_edit</i>
                                    </a>
                                    <a href="/admin:hapusberita={{$data->ID_BERITA}}"  class="btn btn-danger btn-xs"><i class="material-icons">delete_sweep</i>
                                    </a>
