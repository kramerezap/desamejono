...
@section('extrastyle')
<?php
$ambil = DB::table('tb_suratkeluar')->get();
        ...
        <li>
          <a href="javascript:void(0);" class="menu-toggle">
                ...
                <span>Surat Masuk</span>
                  ...
                  <li>
               <a href="{{route('adminsuratkeluar')}}" style="background-color: lightgray">
...
<div class="modal fade" id="modal-edit{{$data->ID_SURAT2}}">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="/admin:updatesuratkeluar={{$data->ID_SURAT2}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body">
...
<div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="/admininsertsuratkeluar" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">No. Surat :</label>
                                 ...
                                 <td>{{$data->TGL_BUAT}}</td>
                                  ...
                                  <td>
                                    <form>
                                      ...
                                      <a href="#" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#modal-edit{{$data->ID_SURAT2}}">
                                        <i class="material-icons">mode_edit</i>
                                    </a>
                                    <a href="/admin:hapussuratkeluar={{$data->ID_SURAT2}}"  class="btn btn-danger btn-xs" onclick="return(confirm('Anda Yakin Menghapus Surat Keluar?? ')
