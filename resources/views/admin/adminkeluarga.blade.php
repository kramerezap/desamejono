...
$ambil = DB::select("select * from tb_keluarga left join tb_rt on tb_rt.id_rt = tb_keluarga.id_rt left join tb_rw on tb_rw.id_rw = tb_keluarga.id_rw  where tb_keluarga.VIEW='1'");
...
<div class="modal fade" id="modal-edit{{$data->NO_KK}}">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="/admin:updatekeluarga={{$data->NO_KK}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">No. KK :</label>
                ...
                <option value="{{$rt->ID_RT}}">{{$rt->NO_RT}}</option>
                  @endforeach
                    ...
                    <br>
                       <label for="exampleInputEmail1">Alamat  :</label>
                    <input type="text" style="border-bottom:  solid 1.7px grey;" class="form-control" id="alamat" name="alamat" placeholder="Contoh : Sumbermulyo" required="true" value="{{$data->ALAMAT}}">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="tabelmodalkeluarga">
                        <thead> 
                        ...
                        <tbody>
                          @php
                          $ambilanggotaa = DB::table('tb_penduduk')->where('NO_KK', $data->NO_KK)->get();                   
                          @endphp
